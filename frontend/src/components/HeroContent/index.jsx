...
const HeroContent = ({ link, img, title, description }) => {
  ...
  return (
    <Link
      to={link}
      className='hero-content relative flex-col gap-12 rounded-xl transition-all lg:flex-row hover:-translate-y-1 hover:shadow-lg after:absolute after:contents after:bg-violet-600 even:flex-row-reverse'
